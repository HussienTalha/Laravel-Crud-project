...
class Container_1d066699dc extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService081(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			...
			[
				...
				'/media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/stubs/helpers.stub',
			],
			['/media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog']
		);
	}
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_1d066699dc $container)
			{
	...
	public function createServiceContainer(): Container_1d066699dc
	{
		return $this;
	}
