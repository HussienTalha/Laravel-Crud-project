...
class Container_c7b9545b98 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_c7b9545b98 $container)
			{
	...
	public function createServiceContainer(): Container_c7b9545b98
	{
		return $this;
	}
