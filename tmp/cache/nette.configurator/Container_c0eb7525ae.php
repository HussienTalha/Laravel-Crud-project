...
// source: phar:///media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon
...
class Container_c0eb7525ae extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_c0eb7525ae $container)
			{
	...
	public function createServiceContainer(): Container_c0eb7525ae
	{
		return $this;
	}
