...
// source: phar:///media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon
...
class Container_6a439dfbbf extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\PhpDoc\TypeNodeResolverExtension' => [['0783', '0784', '0792', '0796', '0797']],
		...
		'PHPStan\PhpDoc\TypeNodeResolverAwareExtension' => [['0797']],
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_6a439dfbbf $container)
			{
	...
	public function createServiceContainer(): Container_6a439dfbbf
	{
		return $this;
	}
