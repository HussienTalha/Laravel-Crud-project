...
// source: phar:///media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon
...
class Container_620d68dc5c extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_620d68dc5c $container)
			{
	...
	public function createServiceContainer(): Container_620d68dc5c
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'OLDPWD' => '/media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/app',
				'LINES' => '18',
				'COLUMNS' => '114',
				'SHELL_VERBOSITY' => '0',
			],
