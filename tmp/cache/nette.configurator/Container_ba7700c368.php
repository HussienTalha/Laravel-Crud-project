...
// source: phar:///media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon
...
class Container_ba7700c368 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService045(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'phar:///media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'phar:///media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon',
				'phar:///media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
				'phar:///media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_ba7700c368 $container)
			{
	...
	public function createServiceContainer(): Container_ba7700c368
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'OLDPWD' => '/media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/bin',
				'LINES' => '18',
				'COLUMNS' => '114',
				'SHELL_VERBOSITY' => '0',
			],
