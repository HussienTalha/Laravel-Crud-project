...
class Container_daf70c1f21 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_daf70c1f21 $container)
			{
	...
	public function createServiceContainer(): Container_daf70c1f21
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'features' => ['skipCheckGenericClasses' => true],
			'debugMode' => true,
