...
// source: phar:///media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/phpstan/phpstan/phpstan.phar/src/PhpDoc/../../conf/config.stubValidator.neon
// source: array
...
class Container_07e8cee33f extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\PhpDoc\StubSourceLocatorFactory' => [['0856']],
	];
	...
	public function createService045(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'phar:///media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/phpstan/phpstan/phpstan.phar/conf/config.stubValidator.neon',
			],
			null,
			[
	...
	public function createService081(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			...
			[
				...
				'/media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/stubs/auth.stub',
			],
			['/media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog']
		);
	}
	...
	public function createService0348(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			...
			[
				'phar:///media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'/media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/phpstan.neon',
				'phar:///media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog/vendor/phpstan/phpstan/phpstan.phar/src/PhpDoc/../../conf/config.stubValidator.neon',
			],
			$this->getParameter('analysedPaths'),
			['/media/talha/225cc24f-0576-4344-ad66-f11a054af19c2/laravel/blog'],
			$this->getParameter('analysedPathsFromConfig'),
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_07e8cee33f $container)
			{
	...
	public function createService0856(): PHPStan\PhpDoc\StubSourceLocatorFactory
	{
	...
	public function createServiceContainer(): Container_07e8cee33f
	{
		return $this;
	}
	...
	{
		return $this->getService('0856')->create();
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				'SHELL' => '/bin/bash',
				'SESSION_MANAGER' => 'local/talha-Inspiron-5559:@/tmp/.ICE-unix/2827,unix/talha-Inspiron-5559:/tmp/.ICE-unix/2827',
				'QT_ACCESSIBILITY' => '1',
				'COLORTERM' => 'truecolor',
				...
				'XAUTHORITY' => '/run/user/1000/.mutter-Xwaylandauth.KNAOL3',
				'HOME' => '/home/talha',
				'USERNAME' => 'talha',
				'IM_CONFIG_PHASE' => '1',
				...
				'GNOME_TERMINAL_SCREEN' => '/org/gnome/Terminal/screen/b612b77d_9af6_4daa_b3a4_ca557febd276',
				...
				'LC_TIME' => 'ar_EG.UTF-8',
				'XDG_DATA_DIRS' => '/usr/share/ubuntu:/usr/share/gnome:/home/talha/.local/share/flatpak/exports/share:/var/lib/flatpak/exports/share:/usr/local/share/:/usr/share/:/var/lib/snapd/desktop',
				'PATH' => '/home/talha/.nvm/versions/node/v20.20.0/bin:/home/talha/.config/composer/vendor/bin:/home/talha/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/snap/bin:/home/talha/.local/bin:/home/talha/.local/bin',
				'GDMSESSION' => 'ubuntu',
				'DBUS_SESSION_BUS_ADDRESS' => 'unix:path=/run/user/1000/bus',
				'NVM_BIN' => '/home/talha/.nvm/versions/node/v20.20.0/bin',
				'LC_NUMERIC' => 'ar_EG.UTF-8',
				'_' => './vendor/bin/phpstan',
				'OLDPWD' => '/media/talha/225cc24f-0576-4344-ad66-f11a054af19c2',
				'LINES' => '24',
				'COLUMNS' => '80',
				'SHELL_VERBOSITY' => '0',
				'APP_NAME' => 'TalhaBlog',
				'APP_ENV' => 'local',
				'APP_KEY' => 'base64:6XarDpSL1+Bf8LxqS3RJ5OqbMabFLD2xaEUFZmx0nRA=',
				'APP_DEBUG' => 'true',
				...
				'MAIL_FROM_NAME' => 'TalhaBlog',
				'AWS_ACCESS_KEY_ID' => '',
				'AWS_SECRET_ACCESS_KEY' => '',
				'AWS_DEFAULT_REGION' => 'us-east-1',
				'AWS_BUCKET' => '',
				'AWS_USE_PATH_STYLE_ENDPOINT' => 'false',
				'VITE_APP_NAME' => 'TalhaBlog',
			],
		];
	}
