...
class Container_a22c491121 extends _PHPStan_f1e88529a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0365(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a22c491121 $container)
			{
	...
	public function createServiceContainer(): Container_a22c491121
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				'SHELL' => '/bin/bash',
				'SESSION_MANAGER' => 'local/talha-Inspiron-5559:@/tmp/.ICE-unix/2714,unix/talha-Inspiron-5559:/tmp/.ICE-unix/2714',
				'QT_ACCESSIBILITY' => '1',
				'COLORTERM' => 'truecolor',
				...
				'XAUTHORITY' => '/run/user/1000/.mutter-Xwaylandauth.TFLNL3',
				'HOME' => '/home/talha',
				'USERNAME' => 'talha',
				'IM_CONFIG_PHASE' => '1',
				...
				'GNOME_TERMINAL_SCREEN' => '/org/gnome/Terminal/screen/ba38908d_83c3_4b70_a23d_8a712b156b06',
